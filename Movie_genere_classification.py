...
# Train a MultiOutput Naive Bayes classifier using the training datal
...
# Assuming test_results is a DataFrame with columns 'MOVIE_NAME' and 'PREDICTED_GENRES'
...
with open("movie_genre_model_evaluation.csv", "w", newline='', encoding="utf-8") as output_file:
    ...
    # Writing each row from the DataFrame
...
with open("movie_genre_model_evaluation.csv", "a", newline='', encoding="utf-8") as output_file:
    ...
    # Writing the model evaluation metrics
